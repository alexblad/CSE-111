...
def main():
    ...
    chemical_formula=input('Please input your chemical formula: ')
    
    # Get the mass of a chemical sample in grams from the user.
    sample_mass=float(input('Please enter your sample mass in grams: '))
    ...
    print(round(molar_mass,6))
    # Print the number of moles.
    print(round(number_moles,5))

#Function that makes periodic table
#using compund a compound list
def make_periodic_table():
    #These are the indexes of each
    #element the inner lists
    #NAME_INDEX=0
    #ATOMIC_MASS_INDEX=1
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for inner_list in symbol_quantity_list: 
        ...
        part_mass=atomic_mass*quantity
        # Add the product into the total molar mass.
        molar_mass += part_mass
...
#For when p table was a compound list
    #SYMBOL_INDEX=0
    #NAME_INDEX=1
    #ATOMIC_MASS_INDEX=2
    ...
    #for inner_list in periodic_table:
        #name_list=inner_list[NAME_INDEX]
        #mass_list=inner_list[ATOMIC_MASS_INDEX]

        #print(name_list, mass_list)